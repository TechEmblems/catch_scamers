...
class InstallmentsControllerTest < ActionController::TestCase
  ...
  test "should create installment" do
    assert_difference('Installment.count') do
      post :create, installment: { amount: @installment.amount, paid_on: @installment.paid_on, purchase_id: @installment.purchase_id }
    end
  ...
  test "should update installment" do
    patch :update, id: @installment, installment: { amount: @installment.amount, paid_on: @installment.paid_on, purchase_id: @installment.purchase_id }
    assert_redirected_to installment_path(assigns(:installment))
  end
